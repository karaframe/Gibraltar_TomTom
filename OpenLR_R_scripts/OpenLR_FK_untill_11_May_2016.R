...
traffic <- read.csv("traffic_flow_FK_until_11_May_2016.csv")   # until 11 May 2016
head(traffic)
...
write.csv(POINTS_1st, "points_traffic_flow_1st_until_11_May.csv")
...
write.csv(POINTS_1st, "points_traffic_flow_2nd_until_11_May.csv")

#########################################################################################
#########################################################################################

POINTS_1st <- read.csv("points_traffic_flow_1st_until_11_May.csv")[2:4]
POINTS_2nd <- read.csv("points_traffic_flow_2nd_until_11_May.csv")[2:4]
...
# to use with ImageMagik using the commnad line "cmd" in windows in the directory "C:/PostgreSQL_Gibraltair/OpenLR/hours_NO2"
